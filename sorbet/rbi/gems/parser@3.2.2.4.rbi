...
class Parser::AST::Processor < ::AST::Processor
  # pkg:gem/parser#lib/parser/ast/processor.rb:177
  def on_alias(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:220
  def on_and(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:65
  def on_and_asgn(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:120
  def on_arg(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:146
  def on_arg_expr(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:101
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:211
  def on_break(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:226
  def on_case(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:244
  def on_case_match(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:87
  def on_casgn(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:155
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:188
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:167
  def on_defs(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:14
  def on_dstr(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:15
  def on_dsym(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:229
  def on_eflipflop(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:286
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:152
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:245
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:191
  def on_indexasgn(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:24
  def on_irange(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:37
  def on_ivar(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:61
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:239
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:194
  def on_lambda(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:36
  def on_lvar(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:60
  def on_lvasgn(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:77
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:232
  def on_match_with_lvasgn(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:76
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:121
  def on_optarg(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:221
  def on_or(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:66
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:242
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:235
  def on_rescue(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:122
  def on_restarg(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:147
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:176
  ...
  # pkg:gem/parser#lib/parser/ast/processor.rb:204
  def on_while(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:205
  ...
  # @private
  #
  # pkg:gem/parser#lib/parser/ast/processor.rb:116
  def process_argument_node(node); end

  # pkg:gem/parser#lib/parser/ast/processor.rb:10
  def process_regular_node(node); end

  # @private
  # @private
  #
  # pkg:gem/parser#lib/parser/ast/processor.rb:56
  def process_var_asgn_node(node); end

  # @private
  # @private
  #
  # pkg:gem/parser#lib/parser/ast/processor.rb:32
...
#
# pkg:gem/parser#lib/parser/base.rb:16
class Parser::Base < ::Racc::Parser
  # @param [Parser::Builders::Default] builder The AST builder to use.
  #
  # pkg:gem/parser#lib/parser/base.rb:126
  def initialize(builder = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/base.rb:114
  def builder; end
  ...
  # pkg:gem/parser#lib/parser/base.rb:113
  def diagnostics; end

  # pkg:gem/parser#lib/parser/base.rb:112
  def lexer; end
  ...
  #
  # pkg:gem/parser#lib/parser/base.rb:186
  ...
  # @return [Array]
  #
  # pkg:gem/parser#lib/parser/base.rb:204
  ...
  #
  # pkg:gem/parser#lib/parser/base.rb:167
  def reset; end
  ...
  # @return [Array]
  #
  # pkg:gem/parser#lib/parser/base.rb:233
  def tokenize(source_buffer, recover = T.unsafe(nil)); end

  private

  # pkg:gem/parser#lib/parser/base.rb:257
  def check_kwarg_name(name_t); end

  # pkg:gem/parser#lib/parser/base.rb:266
  def diagnostic(level, reason, arguments, location_t, highlights_ts = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/base.rb:251
  def next_token; end

  # pkg:gem/parser#lib/parser/base.rb:282
  def on_error(error_token_id, error_value, value_stack); end

  class << self
    # @return [Parser::Base] parser with the default options set.
    #
    # pkg:gem/parser#lib/parser/base.rb:84
    ...
    #
    # pkg:gem/parser#lib/parser/base.rb:30
    ...
    # @see #parse
    #
    # pkg:gem/parser#lib/parser/base.rb:64
    ...
    # @see #parse
    #
    # pkg:gem/parser#lib/parser/base.rb:77
...
class Parser::Builders::Default
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:690
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:616
  def accessible(node); end

  # pkg:gem/parser#lib/parser/builders/default.rb:865
  def alias(alias_t, to, from); end

  # pkg:gem/parser#lib/parser/builders/default.rb:904
  def arg(name_t); end

  # Ruby 1.8 block arguments
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:994
  def arg_expr(expr); end

  # Formal arguments
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:874
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1577
  def array_pattern(lbrack_t, elements, rbrack_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:754
  def assign(lhs, eql_t, rhs); end

  # Assignment
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:699
  def assignable(node); end

  # pkg:gem/parser#lib/parser/builders/default.rb:540
  def associate(begin_t, pairs, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1158
  def attr_asgn(receiver, dot_t, selector_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:606
  def back_ref(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1422
  def begin(begin_t, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1364
  def begin_body(compound_stmt, rescue_bodies = T.unsafe(nil), else_t = T.unsafe(nil), else_ = T.unsafe(nil), ensure_t = T.unsafe(nil), ensure_ = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1440
  def begin_keyword(begin_t, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1192
  def binary_op(receiver, operator_t, arg); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1109
  def block(method_call, begin_t, args, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1144
  def block_pass(amper_t, arg); end

  # pkg:gem/parser#lib/parser/builders/default.rb:969
  def blockarg(amper_t, name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1014
  def blockarg_expr(amper_t, expr); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1100
  def call_lambda(lambda_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1083
  def call_method(receiver, dot_t, selector_t, lparen_t = T.unsafe(nil), args = T.unsafe(nil), rparen_t = T.unsafe(nil)); end

  # Method calls
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1055
  def call_type_for_dot(dot_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1297
  def case(case_t, expr, when_bodies, else_t, else_body, end_t); end

  # PATTERN MATCHING
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1460
  ...
  # Expression grouping
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1410
  def compstmt(statements); end

  # Conditionals
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1273
  def condition(cond_t, cond, then_t, if_true, else_t, if_false, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1279
  def condition_mod(if_true, if_false, cond_t, cond); end

  # pkg:gem/parser#lib/parser/builders/default.rb:673
  def const(name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:685
  def const_fetch(scope, t_colon2, name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:678
  def const_global(t_colon3, name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:750
  def const_op_assignable(node); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1607
  def const_pattern(const, ldelim_t, pattern, rdelim_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:601
  def cvar(token); end
  ...
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:801
  def def_class(class_t, name, lt_t, superclass, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:832
  def def_endless_method(def_t, name_t, args, assignment_t, body); end

  # pkg:gem/parser#lib/parser/builders/default.rb:850
  def def_endless_singleton(def_t, definee, dot_t, name_t, args, assignment_t, body); end

  # Method (un)definition
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:824
  def def_method(def_t, name_t, args, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:814
  def def_module(module_t, name, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:808
  def def_sclass(class_t, lshft_t, expr, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:840
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:900
  def forward_arg(dots_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:890
  def forward_only_args(begin_t, dots_t, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1071
  def forwarded_args(dots_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1079
  def forwarded_kwrestarg(dstar_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1075
  def forwarded_restarg(star_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:596
  def gvar(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1571
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1466
  def in_match(lhs, in_t, rhs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1481
  def in_pattern(in_t, pattern, guard, then_t, body); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1167
  def index(receiver, lbrack_t, indexes, rbrack_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1181
  ...
  # Keywords
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1326
  def keyword_cmd(type, keyword_t, lparen_t = T.unsafe(nil), args = T.unsafe(nil), rparen_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:931
  def kwarg(name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:957
  def kwnilarg(dstar_t, nil_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:938
  def kwoptarg(name_t, value); end

  # pkg:gem/parser#lib/parser/builders/default.rb:945
  ...
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1266
  def logical_op(type, lhs, op_t, rhs); end

  # Loops
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1304
  def loop(type, keyword_t, cond, do_t, body, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1309
  def loop_mod(type, body, keyword_t, cond); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1621
  def match_alt(left, pipe_t, right); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1628
  def match_as(value, assoc_t, as); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1507
  def match_hash_var(name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1521
  def match_hash_var_from_str(begin_t, strings, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1659
  def match_label(label_type, label); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1635
  def match_nil_pattern(dstar_t, nil_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1214
  def match_op(receiver, match_t, arg); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1640
  def match_pair(label_type, label, value); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1471
  def match_pattern(lhs, match_t, rhs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1476
  def match_pattern_p(lhs, match_t, rhs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1560
  def match_rest(star_t, name_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1495
  def match_var(name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1603
  def match_with_trailing_comma(match, comma_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:792
  def multi_assign(lhs, eql_t, rhs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:787
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1242
  def not_op(not_t, begin_t = T.unsafe(nil), receiver = T.unsafe(nil), end_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:611
  def nth_ref(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:886
  def numargs(max_numparam); end

  # MacRuby Objective-C arguments
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1025
  def objc_kwarg(kwname_t, assoc_t, name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1039
  def objc_restarg(star_t, name = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1149
  def objc_varargs(pair, rest_of_varargs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:761
  def op_assign(lhs, op_t, rhs); end

  # pkg:gem/parser#lib/parser/builders/default.rb:911
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1616
  def pin(pin_t, var); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1349
  def postexe(postexe_t, lbrace_t, compstmt, rbrace_t); end

  # BEGIN, END
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1344
  def preexe(preexe_t, lbrace_t, compstmt, rbrace_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:979
  ...
  # Exception handling
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1356
  def rescue_body(rescue_t, exc_list, assoc_t, exc_var, then_t, compound_stmt); end

  # pkg:gem/parser#lib/parser/builders/default.rb:920
  def restarg(star_t, name_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1003
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:962
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1284
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1230
  def unary_op(op_t, receiver); end

  # pkg:gem/parser#lib/parser/builders/default.rb:860
  def undef_method(undef_t, names); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1491
  def unless_guard(unless_t, unless_body); end

  # Case matching
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1291
  ...
  # pkg:gem/parser#lib/parser/builders/default.rb:1808
  def arg_name_collides?(this_name, that_name); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2004
  def arg_prefix_map(op_t, name_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1978
  def binary_op_map(left_e, op_t, right_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2106
  def block_map(receiver_l, begin_t, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1783
  def check_assignment_to_numparam(name, loc); end

  # VERIFICATION
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1675
  def check_condition(cond); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1754
  def check_duplicate_arg(this_arg, map = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1729
  def check_duplicate_args(args, map = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1841
  def check_duplicate_pattern_key(name, loc); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1831
  def check_duplicate_pattern_variable(name, loc); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1823
  def check_lvar_name(name, loc); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1798
  def check_reserved_for_numparam(name, loc); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2263
  def collapse_string_parts?(parts); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1929
  def collection_map(begin_t, parts, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2133
  def condition_map(keyword_t, cond_e, begin_t, body_e, else_t, else_e, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1964
  def constant_map(scope, colon2_t, name_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2037
  def definition_map(keyword_t, operator_t, name_t, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1870
  def delimited_string_map(string_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2285
  def diagnostic(type, reason, arguments, location, highlights = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2177
  def eh_keyword_map(compstmt_e, keyword_t, body_es, else_t, else_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2043
  def endless_definition_map(keyword_t, operator_t, name_t, assignment_t, body_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1925
  def expr_map(loc); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2158
  def for_map(keyword_t, in_t, begin_t, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2205
  def guard_map(keyword_t, guard_body_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2095
  def index_map(receiver_e, lbrack_t, rbrack_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1861
  def join_exprs(left_expr, right_expr); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2111
  def keyword_map(keyword_t, begin_t, args, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2128
  def keyword_mod_map(pre_e, keyword_t, post_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2014
  def kwarg_map(name_t, value_e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2316
  def kwargs?(node); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2280
  def loc(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2027
  def module_definition_map(keyword_t, name_e, operator_t, end_t); end

  # SOURCE MAPS
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:1853
  def n(type, children, source_map); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1857
  def n0(type, source_map); end

  # pkg:gem/parser#lib/parser/builders/default.rb:288
  def numeric(kind, token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1895
  def pair_keyword_map(key_t, value_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1910
  def pair_quoted_map(begin_t, end_t, value_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1881
  def prefix_string_map(symbol); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1992
  def range_map(start_e, op_t, end_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1959
  def regexp_map(begin_t, end_t, options_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2164
  def rescue_body_map(keyword_t, exc_list_e, assoc_t, exc_var_e, then_t, compstmt_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2306
  def rewrite_hash_args_to_kwargs(args); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2077
  def send_binary_op_map(lhs_e, selector_t, rhs_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2100
  def send_index_map(receiver_e, lbrack_t, rbrack_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2051
  def send_map(receiver_e, dot_t, selector_t, begin_t = T.unsafe(nil), args = T.unsafe(nil), end_t = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2083
  def send_unary_op_map(selector_t, arg_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2236
  def static_regexp(parts, options); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2256
  ...
  # at parse time.
  #
  # pkg:gem/parser#lib/parser/builders/default.rb:2219
  def static_string(nodes); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1945
  def string_map(begin_t, parts, end_t); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2272
  def string_value(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2153
  def ternary_map(begin_e, question_t, mid_e, colon_t, end_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1866
  def token_map(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1982
  def unary_op_map(op_t, arg_e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1890
  def unquoted_map(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2294
  def validate_definee(definee); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1768
  def validate_no_forward_arg_after_restarg(args); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2268
  def value(token); end

  # pkg:gem/parser#lib/parser/builders/default.rb:2071
  def var_send_map(variable_e); end

  # pkg:gem/parser#lib/parser/builders/default.rb:1974
...
class Parser::Context
  # pkg:gem/parser#lib/parser/context.rb:29
  def initialize; end

  # pkg:gem/parser#lib/parser/context.rb:43
  def in_argdef; end
  ...
  # pkg:gem/parser#lib/parser/context.rb:33
  def reset; end
end
...
class Parser::Lexer
  ...
  # pkg:gem/parser#lib/parser/lexer-F1.rb:8358
  def encoding; end
  ...
  # pkg:gem/parser#lib/parser/lexer-F1.rb:8387
  def push_cmdarg; end
  ...
  # pkg:gem/parser#lib/parser/lexer-F1.rb:8334
  def source_buffer=(source_buffer); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:8379
  def state; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:8383
  def state=(state); end
  ...
  # pkg:gem/parser#lib/parser/lexer-F1.rb:14631
  def arg_or_cmdarg(cmd_state); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14693
  def check_ambiguous_slash(tm); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14655
  def diagnostic(type, reason, arguments = T.unsafe(nil), location = T.unsafe(nil), highlights = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14661
  def e_lbrace; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14605
  def emit(type, value = T.unsafe(nil), s = T.unsafe(nil), e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14714
  def emit_class_var(ts = T.unsafe(nil), te = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14742
  def emit_colon_with_digits(p, tm, diag_msg); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14639
  def emit_comment(s = T.unsafe(nil), e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14651
  def emit_comment_from_range(p, pe); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14621
  def emit_do(do_block = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14704
  def emit_global_var(ts = T.unsafe(nil), te = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14722
  def emit_instance_var(ts = T.unsafe(nil), te = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14730
  def emit_rbrace_rparen_rbrack; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14752
  def emit_singleton_class; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14615
  def emit_table(table, s = T.unsafe(nil), e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14670
  def numeric_literal_int; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14689
  def on_newline(p); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14601
  def range(s = T.unsafe(nil), e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14592
  def stack_pop; end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14597
  def tok(s = T.unsafe(nil), e = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer-F1.rb:14588
...
# pkg:gem/parser#lib/parser/lexer-F1.rb:14799
Parser::Lexer::ESCAPE_WHITESPACE = T.let(T.unsafe(nil), Hash)

# pkg:gem/parser#lib/parser/lexer-F1.rb:14785
...
# pkg:gem/parser#lib/parser/lexer-F1.rb:8362
...
class Parser::Lexer::Literal
  ...
  # pkg:gem/parser#lib/parser/lexer/literal.rb:114
  def backslash_delimited?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:37
  def dedent_level; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:189
  def end_interp_brace_and_try_closing; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:216
  def extend_content; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:220
  def extend_space(ts, te); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:195
  def extend_string(string, ts, te); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:202
  def flush_string; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:102
  def heredoc?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:37
  def heredoc_e; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:166
  def infer_indent_level(line); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:89
  def interpolate?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:122
  def munge_escape?(character); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:132
  def nest_and_try_closing(delimiter, ts, te, lookahead = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:106
  def plain_heredoc?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:98
  def regexp?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:38
  def saved_herebody_s; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:38
  def saved_herebody_s=(_arg0); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:110
  def squiggly_heredoc?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:185
  def start_interp_brace; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:37
  def str_s; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:230
  def supports_line_continuation_via_slash?; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:118
  def type; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:93
  def words?; end

  protected

  # pkg:gem/parser#lib/parser/lexer/literal.rb:248
  def clear_buffer; end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:244
  def coerce_encoding(string); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:236
  def delimiter?(delimiter); end

  # pkg:gem/parser#lib/parser/lexer/literal.rb:264
...
# pkg:gem/parser#lib/parser/lexer-F1.rb:14779
...
class Parser::LexerStrings
  ...
  # pkg:gem/parser#lib/parser/lexer-strings.rb:5397
  def check_ambiguous_slash(tm); end

  # pkg:gem/parser#lib/parser/lexer-strings.rb:5408
  ...
  # pkg:gem/parser#lib/parser/lexer-strings.rb:5387
  ...
  # pkg:gem/parser#lib/parser/lexer-strings.rb:5375
  ...
  # pkg:gem/parser#lib/parser/lexer-strings.rb:5355
  ...
  # pkg:gem/parser#lib/parser/lexer-strings.rb:5347
  def read_post_meta_or_ctrl_char(p); end

  # pkg:gem/parser#lib/parser/lexer-strings.rb:5379
  def slash_c_char; end

  # pkg:gem/parser#lib/parser/lexer-strings.rb:5383
...
# pkg:gem/parser#lib/parser/lexer-strings.rb:5414
...
# @api private
#
# pkg:gem/parser#lib/parser/messages.rb:107
module Parser::Messages
  class << self
    ...
    # @api private
    #
    # pkg:gem/parser#lib/parser/messages.rb:114
...
class Parser::Source::Buffer
  # pkg:gem/parser#lib/parser/source/buffer.rb:105
  ...
  # @api private
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:242
  ...
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:217
  ...
  # pkg:gem/parser#lib/parser/source/buffer.rb:318
  def inspect; end
  ...
  # @return [Integer]
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:307
  def last_line; end
  ...
  # @api private
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:231
  ...
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:284
  ...
  # @return [String]
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:180
  ...
  # @raise  [ArgumentError] if already populated
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:131
  def read; end

  # pkg:gem/parser#lib/parser/source/buffer.rb:194
  ...
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:145
  def source; end
  ...
  # @return [String]
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:162
  ...
  # @raise  [IndexError] if `lineno` is out of bounds
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:273
  ...
  # @return [Array<String>]
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:252
  def source_lines; end

  # @return [Range] A range covering the whole source
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:298
  ...
  # RUBY_VERSION >= 2.3
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:348
  def bsearch(line_begins, position); end

  # @returns [0, line_begin_of_line_1, ..., source.size + 1]
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:325
  def line_begins; end

  # @returns 0-based line index of position
  #
  # pkg:gem/parser#lib/parser/source/buffer.rb:339
  ...
  class << self
    ...
    #
    # pkg:gem/parser#lib/parser/source/buffer.rb:51
    ...
    # @raise  [EncodingError]
    #
    # pkg:gem/parser#lib/parser/source/buffer.rb:90
...
#
# pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:13
class Parser::Source::TreeRewriter::Action
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:16
  ...
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:28
  ...
  # @return [Action]
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:67
  def contract; end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:33
  def empty?; end
  ...
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:57
  def insertion?; end
  ...
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:80
  def moved(source_buffer, offset); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:49
  def nested_actions; end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:40
  ...
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:158
  ...
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:145
  def bsearch_child_index(from = T.unsafe(nil)); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:224
  def call_enforcer_for_merge(action); end

  # @param [Array(Action | nil)] fusible
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:204
  def check_fusible(action, *fusible); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:94
  def children; end

  # Assumes `more_children` all contained within `@range`
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:129
  def combine_children(more_children); end

  # Assumes range.contains?(action.range) && action.children.empty?
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:102
  def do_combine(action); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:135
  def fuse_deletions(action, fusible, other_sibblings); end

  # Assumes action.range == range && action.children.empty?
  #
  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:215
  def merge(action); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:110
  def place_in_hierarchy(action); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:232
  def swallow(children); end

  # pkg:gem/parser#lib/parser/source/tree_rewriter/action.rb:96
...
class Parser::StaticEnvironment
  ...
  # pkg:gem/parser#lib/parser/static_environment.rb:40
  def declare(name); end

  # pkg:gem/parser#lib/parser/static_environment.rb:58
  def declare_anonymous_blockarg; end

  # pkg:gem/parser#lib/parser/static_environment.rb:74
  def declare_anonymous_kwrestarg; end

  # pkg:gem/parser#lib/parser/static_environment.rb:66
  def declare_anonymous_restarg; end

  # pkg:gem/parser#lib/parser/static_environment.rb:50
  def declare_forward_args; end

  # pkg:gem/parser#lib/parser/static_environment.rb:46
  def declared?(name); end

  # pkg:gem/parser#lib/parser/static_environment.rb:62
  def declared_anonymous_blockarg?; end

  # pkg:gem/parser#lib/parser/static_environment.rb:78
  def declared_anonymous_kwrestarg?; end

  # pkg:gem/parser#lib/parser/static_environment.rb:70
  def declared_anonymous_restarg?; end

  # pkg:gem/parser#lib/parser/static_environment.rb:54
  def declared_forward_args?; end

  # pkg:gem/parser#lib/parser/static_environment.rb:82
  def empty?; end

  # pkg:gem/parser#lib/parser/static_environment.rb:27
  def extend_dynamic; end

  # pkg:gem/parser#lib/parser/static_environment.rb:20
  def extend_static; end

  # pkg:gem/parser#lib/parser/static_environment.rb:15
  def reset; end

  # pkg:gem/parser#lib/parser/static_environment.rb:34
  def unextend; end
end

# pkg:gem/parser#lib/parser/static_environment.rb:7
