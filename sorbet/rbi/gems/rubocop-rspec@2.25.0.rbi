...
class RuboCop::Cop::RSpec::AroundBlock < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/around_block.rb:84
...
class RuboCop::Cop::RSpec::Base < ::RuboCop::Cop::Base
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/base.rb:20
  def on_new_investigation; end

  class << self
    # Invoke the original inherited hook so our cops are recognized
    #
    # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/base.rb:14
...
class RuboCop::Cop::RSpec::BeEmpty < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/be_empty.rb:34
  def on_send(node); end
end
...
class RuboCop::Cop::RSpec::BeNil < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/be_nil.rb:64
  def check_be_nil_style(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/be_nil.rb:56
...
class RuboCop::Cop::RSpec::BeforeAfterAll < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/before_after_all.rb:36
  def before_or_after_all(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/before_after_all.rb:40
  def on_send(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/before_after_all.rb:28
RuboCop::Cop::RSpec::BeforeAfterAll::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/before_after_all.rb:33
RuboCop::Cop::RSpec::BeforeAfterAll::RESTRICT_ON_SEND = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/current_path_expectation.rb:6
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/current_path_expectation.rb:34
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:44
class RuboCop::Cop::RSpec::Capybara::FeatureMethods < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RSpec::InsideExampleGroup
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:61
  def capybara_speak(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:66
  def feature_method(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:84
  def message(range); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:72
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:91
  def enabled?(method_name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:95
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:51
RuboCop::Cop::RSpec::Capybara::FeatureMethods::MAP = T.let(T.unsafe(nil), Hash)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/feature_methods.rb:48
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/match_style.rb:34
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/negation_matcher.rb:29
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/specific_actions.rb:25
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/specific_finders.rb:20
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/specific_matcher.rb:31
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/capybara/visibility_matcher.rb:32
...
class RuboCop::Cop::RSpec::ChangeByZero < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:86
  def change_nodes(param0); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:69
  def expect_change_with_arguments(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:76
  def expect_change_with_block(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:90
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:131
  def autocorrect(corrector, node, change_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:138
  def autocorrect_compound(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:118
  def compound_expectations?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:122
  def message(change_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:126
  def message_compound(change_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:148
  def negated_matcher; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:152
  def preferred_method; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:103
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:62
RuboCop::Cop::RSpec::ChangeByZero::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:63
RuboCop::Cop::RSpec::ChangeByZero::MSG_COMPOUND = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/change_by_zero.rb:66
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/contain_exactly.rb:22
class RuboCop::Cop::RSpec::ContainExactly < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/contain_exactly.rb:28
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/contain_exactly.rb:44
  def autocorrect_for_populated_array(node, corrector); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/contain_exactly.rb:36
  def check_populated_collection(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/contain_exactly.rb:25
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:58
class RuboCop::Cop::RSpec::ContextWording < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:68
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:79
  def allowed_patterns; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:87
  def bad_pattern?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:93
  def description(context); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:101
  def expect_patterns; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:83
  def prefix_regexes; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/context_wording.rb:111
  def prefixes; end
end
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:57
class RuboCop::Cop::RSpec::DescribedClass < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::ConfigurableEnforcedStyle
  include ::RuboCop::Cop::RSpec::Namespace
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:66
  def common_instance_exec_closure?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:83
  def contains_described_class?(param0); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:78
  def described_constant(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:86
  def on_block(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:71
  def rspec_block?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:75
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:179
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:196
  def const_name(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:113
  def find_usage(node, &block); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:164
  def full_const_name(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:123
  def message(offense); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:142
  def offensive?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:150
  def offensive_described_class?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:132
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:62
RuboCop::Cop::RSpec::DescribedClass::DESCRIBED_CLASS = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/described_class.rb:63
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/dialect.rb:45
class RuboCop::Cop::RSpec::Dialect < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::MethodPreference
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/dialect.rb:54
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/dialect.rb:52
  def rspec_method?(param0 = T.unsafe(nil)); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/dialect.rb:49
...
class RuboCop::Cop::RSpec::EmptyExampleGroup < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_example_group.rb:138
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_example_group.rb:164
  def conditionals_with_examples?(body); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_example_group.rb:172
  def examples_in_branches?(condition_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_example_group.rb:153
  def offensive?(body); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_example_group.rb:178
...
class RuboCop::Cop::RSpec::EmptyMetadata < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/empty_metadata.rb:32
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:51
class RuboCop::Cop::RSpec::ExampleWithoutDescription < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:61
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:75
  def check_example_without_description(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:82
  def disallow_empty_description?(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:56
RuboCop::Cop::RSpec::ExampleWithoutDescription::MSG_ADD_DESCRIPTION = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_without_description.rb:54
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:46
class RuboCop::Cop::RSpec::ExampleWording < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:58
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:80
  def add_wording_offense(node, message); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:127
  def custom_transform; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:90
  def docstring(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:131
  def ignored_words; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:135
  def insufficient_docstring?(description_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:139
  def insufficient_examples; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:144
  def preprocess(message); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:100
  def replacement_text(node); end

  # Recursive processing is required to process nested dstr nodes
  # that is the case for \-separated multiline strings with interpolation.
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:116
  def text(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:55
RuboCop::Cop::RSpec::ExampleWording::IT_PREFIX = T.let(T.unsafe(nil), Regexp)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:51
RuboCop::Cop::RSpec::ExampleWording::MSG_INSUFFICIENT_DESCRIPTION = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:50
RuboCop::Cop::RSpec::ExampleWording::MSG_IT = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:49
RuboCop::Cop::RSpec::ExampleWording::MSG_SHOULD = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/example_wording.rb:54
...
class RuboCop::Cop::RSpec::ExpectActual < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_actual.rb:67
  def on_send(node); end
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_actual.rb:82
  def literal?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_actual.rb:86
  def simple_literal?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_actual.rb:95
...
#   expect { run }.to change { Foo.bar }
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:32
class RuboCop::Cop::RSpec::ExpectChange < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::ConfigurableEnforcedStyle
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:41
  def expect_change_with_arguments(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:46
  def expect_change_with_block(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:72
  def on_block(node); end
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:36
RuboCop::Cop::RSpec::ExpectChange::MSG_BLOCK = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:37
RuboCop::Cop::RSpec::ExpectChange::MSG_CALL = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_change.rb:38
...
class RuboCop::Cop::RSpec::ExpectOutput < ::RuboCop::Cop::RSpec::Base
  ...
  # don't matter.
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/expect_output.rb:43
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:121
module RuboCop::Cop::RSpec::ExplicitHelper
  include ::RuboCop::RSpec::Language
  extend ::RuboCop::AST::NodePattern::Macros

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:182
  def predicate_matcher?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:191
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:139
  def check_explicit(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:215
  def corrector_explicit(corrector, to_node, actual, matcher, block_child); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:175
  def heredoc_argument?(matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:209
  def message_explicit(matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:222
  def move_predicate(corrector, actual, matcher, block_child); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:200
  def predicate_matcher_name?(name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:162
  def replaceable_matcher?(matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:251
  def replacement_matcher(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:233
  def to_predicate_method(matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:171
  def uncorrectable_matcher?(node, matcher); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:127
RuboCop::Cop::RSpec::ExplicitHelper::BUILT_IN_MATCHERS = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:125
RuboCop::Cop::RSpec::ExplicitHelper::MSG_EXPLICIT = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/attribute_defined_statically.rb:6
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/attribute_defined_statically.rb:30
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/consistent_parentheses_style.rb:45
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/create_list.rb:36
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/factory_class_name.rb:25
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/factory_name_style.rb:29
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/factory_bot/syntax_methods.rb:51
...
#   my_class_spec.rb         # describe MyClass, '#method'
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:65
class RuboCop::Cop::RSpec::FilePath < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RSpec::TopLevelGroup
  include ::RuboCop::Cop::RSpec::Namespace

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:72
  def example_group(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:81
  def on_top_level_example_group(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:79
  def routing_metadata?(param0); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:142
  def camel_to_snake_case(string); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:149
  def custom_transform; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:91
  def ensure_correct_file_path(send_node, example_group, arguments); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:173
  def expanded_file_path; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:132
  def expected_path(constant); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:157
  def filename_ends_with?(pattern); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:153
  def ignore_methods?; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:125
  def name_pattern(method_name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:107
  def pattern_for(example_group, arguments); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:121
  def pattern_for_spec_suffix_only; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:161
  def relevant_rubocop_rspec_file?(_file); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:103
  def routing_spec?(args); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:169
  def routing_spec_path?; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:165
  def spec_suffix_only?; end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/file_path.rb:69
...
#   focus 'test' do; end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:52
class RuboCop::Cop::RSpec::Focus < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:59
  def focusable_selector?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:77
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:81
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:110
  def correct_send(corrector, focus); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:97
  def focus_metadata(node, &block); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:103
  def with_surrounding(focus); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/focus.rb:56
...
class RuboCop::Cop::RSpec::ImplicitSubject < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/implicit_subject.rb:135
  def implicit_subject_in_non_its?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/implicit_subject.rb:139
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/implicit_subject.rb:122
  def invalid?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/implicit_subject.rb:147
  def its?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/implicit_subject.rb:113
...
class RuboCop::Cop::RSpec::IndexedLet < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/indexed_let.rb:104
  def allowed_identifiers; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/indexed_let.rb:98
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/indexed_let.rb:87
  def indexed_let?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/indexed_let.rb:94
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/indexed_let.rb:75
...
module RuboCop::Cop::RSpec::InflectedHelper
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:39
  def be_bool?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:44
  def be_boolthy?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:29
  def predicate_in_actual?(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:48
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:60
  def message_inflected(predicate); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:56
  def predicate?(sym); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:85
  def remove_predicate(corrector, predicate); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:96
  def rewrite_matcher(corrector, predicate, matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:67
  def to_predicate_matcher(name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:107
...
class RuboCop::Cop::RSpec::IteratedExpectation < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:24
  def each?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:33
  def each_numblock?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:40
  def expectation?(param0 = T.unsafe(nil), param1); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:44
  def on_block(node); end
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:66
  def only_expectations?(body, arg); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:62
  def single_expectation?(body, arg); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/iterated_expectation.rb:20
...
class RuboCop::Cop::RSpec::LeakyConstantDeclaration < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/leaky_constant_declaration.rb:107
  def on_class(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/leaky_constant_declaration.rb:113
  def on_module(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/leaky_constant_declaration.rb:121
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:28
class RuboCop::Cop::RSpec::LetSetup < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:32
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:48
  def method_called?(param0, param1); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:50
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:66
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/let_setup.rb:29
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/match_array.rb:25
class RuboCop::Cop::RSpec::MatchArray < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/match_array.rb:32
  def match_array_with_empty_array?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/match_array.rb:36
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/match_array.rb:45
  def check_populated_array(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/match_array.rb:28
...
class RuboCop::Cop::RSpec::MessageExpectation < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_expectation.rb:36
  def message_expectation(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_expectation.rb:43
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_expectation.rb:41
  def receive_message?(param0); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_expectation.rb:56
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_expectation.rb:33
...
class RuboCop::Cop::RSpec::MessageSpies < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:47
  def message_expectation(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:56
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:52
  def receive_message(param0); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:79
  def error_message(receiver); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:75
  def preferred_style?(expectation); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:69
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/message_spies.rb:44
...
class RuboCop::Cop::RSpec::MetadataStyle < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:71
  def autocorrect_symbol(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:78
  def bad_metadata_pair?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:82
  def bad_metadata_symbol?(_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:86
  def format_symbol_to_pair_source(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:90
  def insert_pair(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:101
  def insert_pair_as_last_argument(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:110
  def insert_pair_to_empty_hash_metadata(corrector, node, hash_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:117
  def insert_pair_to_non_empty_hash_metadata(corrector, node, hash_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:124
  def insert_symbol(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:131
  def message_for_style; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:138
  def on_metadata_pair(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:146
  def on_metadata_symbol(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:154
  def remove_pair(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:164
  def remove_pair_following(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:176
  def remove_pair_preceding(corrector, node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/metadata_style.rb:188
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:64
class RuboCop::Cop::RSpec::MultipleExpectations < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:84
  def aggregate_failures_block?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:81
  def expect?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:88
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:104
  def example_with_aggregate_failures?(example_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:111
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:127
  def flag_example(node, expectation_count:); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:138
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_expectations.rb:67
...
class RuboCop::Cop::RSpec::MultipleMemoizedHelpers < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:90
  def on_block(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:101
  def on_new_investigation; end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:110
  def all_helpers(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:142
  def allow_subject?; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:108
  def example_group_memoized_helpers; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:117
  def helpers(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:138
  def max; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:128
  def variable_nodes(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/multiple_memoized_helpers.rb:88
...
class RuboCop::Cop::RSpec::NamedSubject < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:120
  def allow_explicit_subject?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:124
  def always?; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:114
  def check_explicit_subject(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:147
  def find_subject(block_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:109
  def ignored_shared_example?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:128
  def named_only?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:139
  def nearest_subject(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/named_subject.rb:133
...
class RuboCop::Cop::RSpec::NestedGroups < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:106
  def on_top_level_group(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:156
  def allowed_groups; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:133
  def count_up_nesting?(node, example_group); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:118
  def find_nested_example_groups(node, nesting: T.unsafe(nil), &block); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:143
  def max_nesting; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:147
  def max_nesting_config; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:139
  def message(nesting); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:100
RuboCop::Cop::RSpec::NestedGroups::DEPRECATED_MAX_KEY = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:102
RuboCop::Cop::RSpec::NestedGroups::DEPRECATION_WARNING = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/nested_groups.rb:98
...
class RuboCop::Cop::RSpec::PendingWithoutReason < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:82
  def metadata_without_reason?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:102
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:98
  def pending_step_without_reason?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:93
  def skipped_by_example_group_method?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:72
  def skipped_by_example_method?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:77
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:151
  def on_skipped_by_example_group_method(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:141
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/pending_without_reason.rb:116
...
#   expect(foo.something?).to be_truthy
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:314
class RuboCop::Cop::RSpec::PredicateMatcher < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:331
  def on_block(node); end
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/predicate_matcher.rb:320
RuboCop::Cop::RSpec::PredicateMatcher::RESTRICT_ON_SEND = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/avoid_setup_hook.rb:6
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/avoid_setup_hook.rb:20
class RuboCop::Cop::RSpec::Rails::AvoidSetupHook < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/avoid_setup_hook.rb:32
  def on_block(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/avoid_setup_hook.rb:26
  def setup_call(param0 = T.unsafe(nil)); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/avoid_setup_hook.rb:23
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:17
class RuboCop::Cop::RSpec::Rails::HaveHttpStatus < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:28
  def match_status(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:38
  def on_send(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:20
RuboCop::Cop::RSpec::Rails::HaveHttpStatus::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:25
RuboCop::Cop::RSpec::Rails::HaveHttpStatus::RESTRICT_ON_SEND = T.let(T.unsafe(nil), Set)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/have_http_status.rb:24
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:54
class RuboCop::Cop::RSpec::Rails::InferredSpecType < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:79
  def describe_with_type(param0 = T.unsafe(nil)); end

  # @param [RuboCop::AST::BlockNode] node
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:60
  def on_block(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:72
  def on_numblock(node); end
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:91
  def autocorrect(corrector, node); end

  # @param [RuboCop::AST::PairNode] node
  # @return [RuboCop::AST::Node]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:111
  def detect_removable_node(node); end

  # @return [String]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:120
  def file_path; end

  # @return [Hash]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:138
  def inferences; end

  # @param [RuboCop::AST::PairNode] node
  # @return [Boolean]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:126
  def inferred_type?(node); end

  # @return [Symbol, nil]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:131
  def inferred_type_from_file_path; end

  # @param [RuboCop::AST::Node] node
  # @return [Parser::Source::Range]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:97
  def remove_range(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/inferred_spec_type.rb:57
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:20
class RuboCop::Cop::RSpec::Rails::MinitestAssertions < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:27
  def minitest_assertion(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:31
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:53
  def message(prefer); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:43
  def replacement(node, expected, actual, failure_message); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:23
RuboCop::Cop::RSpec::Rails::MinitestAssertions::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/minitest_assertions.rb:24
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:33
class RuboCop::Cop::RSpec::Rails::NegationBeValid < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::ConfigurableEnforcedStyle
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:46
  def be_invalid?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:41
  def not_to?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:50
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:75
  def message(_matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:62
  def offense?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:71
  def offense_range(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:90
  def replaced_matcher; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:81
  def replaced_runner; end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:37
RuboCop::Cop::RSpec::Rails::NegationBeValid::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/negation_be_valid.rb:38
...
#   before { freeze_time }
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:27
class RuboCop::Cop::RSpec::Rails::TravelAround < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:39
  def extract_run_in_travel(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:48
  def match_around_each?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:55
  def on_block(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:66
  def on_numblock(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:70
  def autocorrect(corrector, node, run_node, around_node); end

  # @param node [RuboCop::AST::BlockNode]
  # @return [RuboCop::AST::BlockNode, nil]
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:83
  def extract_surrounding_around_block(node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:30
RuboCop::Cop::RSpec::Rails::TravelAround::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/rails/travel_around.rb:32
...
class RuboCop::Cop::RSpec::ReceiveMessages < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_messages.rb:155
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_never.rb:15
class RuboCop::Cop::RSpec::ReceiveNever < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_never.rb:21
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_never.rb:33
  def autocorrect(corrector, node); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_never.rb:17
RuboCop::Cop::RSpec::ReceiveNever::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/receive_never.rb:18
...
class RuboCop::Cop::RSpec::RepeatedExample < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/repeated_example.rb:31
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:25
class RuboCop::Cop::RSpec::ScatteredSetup < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:32
  def on_block(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:75
  def autocorrect(corrector, first_occurrence, occurrence); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:60
  def lines_msg(numbers); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:68
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/scattered_setup.rb:29
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:23
class RuboCop::Cop::RSpec::SharedExamples < ::RuboCop::Cop::RSpec::Base
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:34
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:27
...
class RuboCop::Cop::RSpec::SharedExamples::Checker
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:53
  def initialize(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:57
  def message; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:51
  def node; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:61
  def preferred_style; end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:68
  def symbol; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:72
  def wrap_with_single_quotes(string); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/shared_examples.rb:48
...
class RuboCop::Cop::RSpec::SingleArgumentMessageChain < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/single_argument_message_chain.rb:77
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/single_argument_message_chain.rb:83
  def key_to_arg(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/single_argument_message_chain.rb:88
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:19
class RuboCop::Cop::RSpec::SortMetadata < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RSpec::Metadata
  include ::RuboCop::Cop::RangeHelp
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:26
  def on_metadata(symbols, hash); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:38
  def crime_scene(symbols, pairs); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:47
  def replacement(symbols, pairs); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:55
  def sort_pairs(pairs); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:59
  def sort_symbols(symbols); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/sort_metadata.rb:51
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:35
class RuboCop::Cop::RSpec::SpecFilePathFormat < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::RSpec::TopLevelGroup
  include ::RuboCop::Cop::RSpec::Namespace
  include ::RuboCop::Cop::RSpec::FileHelp

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:43
  def example_group_arguments(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:48
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:108
  def camel_to_snake_case(string); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:81
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:62
  def ensure_correct_file_path(send_node, class_name, arguments); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:98
  def expected_path(constant); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:127
  def filename_ends_with?(pattern); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:94
  def ignore?(method_name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:123
  def ignore_metadata; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:73
  def ignore_metadata?(arguments); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:119
  def ignore_methods?; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:88
  def name_pattern(method_name); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/spec_file_path_format.rb:40
...
class RuboCop::Cop::RSpec::StubbedMock < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:42
  def configured_response?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:61
  def expectation(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:129
  def matcher_with_blockpass(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:81
  def matcher_with_configured_response(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:108
  def matcher_with_hash(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:93
  def matcher_with_return_block(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:34
  def message_expectation?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:138
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:155
  def msg(method_name); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:144
  def on_expectation(expectation, method_name, matcher); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:161
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/stubbed_mock.rb:136
...
module RuboCop::Cop::RSpec::TopLevelGroup
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:19
  ...
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:27
  def on_top_level_example_group(_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:29
  def on_top_level_group(_node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:48
  def root_node; end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:31
  def top_level_group?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/mixin/top_level_group.rb:35
...
class RuboCop::Cop::RSpec::UnspecifiedException < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/unspecified_exception.rb:38
  def empty_raise_error_or_exception(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/unspecified_exception.rb:47
  def on_send(node); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/unspecified_exception.rb:59
  def block_with_args?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/unspecified_exception.rb:55
...
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/unspecified_exception.rb:35
...
class RuboCop::Cop::RSpec::VariableDefinition < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/variable_definition.rb:67
  def string?(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/variable_definition.rb:62
  def style_offense?(variable); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/variable_definition.rb:71
  def symbol?(node); end
end
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:43
class RuboCop::Cop::RSpec::VerifiedDoubleReference < ::RuboCop::Cop::RSpec::Base
  include ::RuboCop::Cop::ConfigurableEnforcedStyle
  extend ::RuboCop::Cop::AutoCorrector

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:74
  def on_send(node); end
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:101
  def correct_style(offense); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:92
  def opposing_style?(class_reference); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:47
RuboCop::Cop::RSpec::VerifiedDoubleReference::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:60
RuboCop::Cop::RSpec::VerifiedDoubleReference::REFERENCE_TYPE_STYLES = T.let(T.unsafe(nil), Hash)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_double_reference.rb:49
...
#   end
#
# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:26
class RuboCop::Cop::RSpec::VerifiedDoubles < ::RuboCop::Cop::RSpec::Base
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:35
  def on_send(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:31
  def unverified_double(param0 = T.unsafe(nil)); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:46
  def symbol?(name); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:27
RuboCop::Cop::RSpec::VerifiedDoubles::MSG = T.let(T.unsafe(nil), String)

# pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/verified_doubles.rb:28
...
class RuboCop::Cop::RSpec::VoidExpect < ::RuboCop::Cop::RSpec::Base
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/void_expect.rb:36
  def on_block(node); end
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/void_expect.rb:44
  def check_expect(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/cop/rspec/void_expect.rb:50
  def void?(expect); end
end
...
# pkg:gem/rubocop-rspec#lib/rubocop/rspec.rb:7
...
class RuboCop::RSpec::Concept
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:11
  def initialize(node); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:19
  def ==(other); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:15
  def eql?(other); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:21
  def hash; end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:25
  def to_node; end

  protected

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/concept.rb:31
  def node; end
end
...
class RuboCop::RSpec::Hook < ::RuboCop::RSpec::Concept
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/hook.rb:74
  def scope_argument; end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/hook.rb:70
  def scope_name; end
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/inject.rb:7
module RuboCop::RSpec::Inject
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/inject.rb:8
    def defaults!; end
  end
end
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:5
module RuboCop::RSpec::Language
  extend ::RuboCop::AST::NodePattern::Macros
  extend ::RuboCop::RSpec::Language::NodePattern

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:50
  def example?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:29
  def example_group?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:45
  def example_group_with_body?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:26
  def explicit_rspec?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:53
  def hook?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:69
  def include?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:61
  def let?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:23
  def rspec?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:34
  def shared_group?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:38
  def spec_group?(param0 = T.unsafe(nil)); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:77
  def subject?(param0 = T.unsafe(nil)); end

  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:19
    def config; end
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:205
module RuboCop::RSpec::Language::ALL
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:206
    def all(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:79
module RuboCop::RSpec::Language::ExampleGroups
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:81
    def all(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:91
    def focused(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:87
    def regular(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:95
    def skipped(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:101
module RuboCop::RSpec::Language::Examples
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:103
    def all(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:114
    def focused(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:122
    def pending(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:110
    def regular(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:118
    def skipped(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:128
module RuboCop::RSpec::Language::Expectations
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:129
    def all(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:134
module RuboCop::RSpec::Language::Helpers
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:135
    def all(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:146
...
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:147
RuboCop::RSpec::Language::HookScopes::ALL = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:140
module RuboCop::RSpec::Language::Hooks
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:141
    def all(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:153
module RuboCop::RSpec::Language::Includes
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:155
    def all(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:164
    def context(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:160
...
#
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:10
module RuboCop::RSpec::Language::NodePattern
  # @deprecated Prefer using Node Pattern directly
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:30
  def block_or_numblock_pattern(string); end

  # @deprecated Prefer using Node Pattern directly
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:18
  def block_pattern(string); end

  # @deprecated Prefer using Node Pattern directly
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:24
  def numblock_pattern(string); end

  # @deprecated Prefer using Node Pattern directly
  #
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:12
  def send_pattern(string); end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language/node_pattern.rb:37
  def deprecation_warning(method); end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:170
...
# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:171
RuboCop::RSpec::Language::Runners::ALL = T.let(T.unsafe(nil), Array)

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:181
module RuboCop::RSpec::Language::SharedGroups
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:183
    def all(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:192
    def context(element); end

    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:188
    def examples(element); end
  end
end

# pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:198
module RuboCop::RSpec::Language::Subjects
  class << self
    # pkg:gem/rubocop-rspec#lib/rubocop/rspec/language.rb:199
    def all(element); end
  end
end
...
# pkg:gem/rubocop-rspec#lib/rubocop/rspec.rb:6
...
class RuboCop::RSpec::Wording
  ...
  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:18
  def rewrite; end

  private

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:72
  def append_suffix(word, suffix); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:57
  def ignored_word?(word); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:31
  def ignores; end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:43
  def remove_should_and_pluralize; end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:33
  def replace_prefix(pattern, replacement); end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:31
  def replacements; end

  # pkg:gem/rubocop-rspec#lib/rubocop/rspec/wording.rb:61
